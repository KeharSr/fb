...
import sqlite3
keh=Tk()
Label(keh,text="Facebook",font="ariel 20 bold",bg="royal blue",fg="white").grid(row=0,column=2)
keh.title("Facebook")
keh.configure(bg='red')
keh.iconbitmap('fb.ico')
...
def query():
    ...
    qurey_label=Label(keh,text=print_record)
...
f_name=Entry(keh,width=30)
f_name.grid(row=0,column=1,padx=20)
f_name_Label=Label(keh,text='First Name :',bg='royal blue',fg='white',font='tahoma')
f_name_Label.grid(row=0,column=0,pady=(10,0))

l_name=Entry(keh,width=30)
l_name.grid(row=1,column=1)
l_name_label=Label(keh,text='Last Name :',bg='royal blue',fg='white',font='tahoma')
l_name_label.grid(row=1,column=0)


address=Entry(keh,width=30)
address.grid(row=2,column=1)
address_label=Label(keh,text='Address :',bg='royal blue',fg='white',font='tahoma')
address_label.grid(row=2,column=0)



password=Entry(keh,width=30,show='*')
password.grid(row=3,column=1)
password_label=Label(keh,text='Password :',bg='royal blue',fg='white',font='tahoma')
password_label.grid(row=3,column=0)



age=Entry(keh,width=30)
age.grid(row=4,column=1)
age_label=Label(keh,text='Age :',bg='royal blue',fg='white',font='tahoma')
age_label.grid(row=4,column=0)




fatherName=Entry(keh,width=30)
fatherName.grid(row=5,column=1)
fatherName_label=Label(keh,text='Father Name :',bg='royal blue',fg='white',font='tahoma')
fatherName_label.grid(row=5,column=0)



city=Entry(keh,width=30)
city.grid(row=6,column=1)
city_label=Label(keh,text="City :",bg='royal blue',fg='white',font='tahoma')
city_label.grid(row=6,column=0)

zipcode=Entry(keh,width=30)
zipcode.grid(row=7,column=1)
zipcode_label=Label(keh,text='ZipCode :',bg='royal blue',fg='white',font='tahoma')
zipcode_label.grid(row=7,column=0)


delete_box=Entry(keh,width=30)
delete_box.grid(row=11,column=1,pady=20)
delete_label=Label(keh,text="Input ID",bg='royal blue',fg='white',font='tahoma')
delete_label.grid(row=11,column=0,pady=20)
# tasplab=Label(keh,text='perform specific task click the button below*',fg='white',bg='royal blue')
# tasplab.grid(row=10,column=0)

sumbit_btn=Button(keh,text='Add Records',command=submit)
sumbit_btn.grid(row=9,column=0,columnspan=2,pady=10,padx=100)

query_btn=Button(keh,text="Show Records",command=query)
query_btn.grid(row=9,column=1,columnspan=2,pady=10,padx=100)

delete_btn=Button(keh,text='Delete',command=delete)
delete_btn.grid(row=14,column=0,columnspan=5,pady=10,padx=100,ipadx=1)

edit_btn=Button(keh,text="Update",command=edit)
